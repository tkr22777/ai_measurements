...
interface UsePhotoCaptureReturn {
  ...
  capturePhoto: (video: HTMLVideoElement, facingMode: 'user' | 'environment', stopStream?: () => void) => string | null;
  downloadPhoto: () => void;
  resetPhoto: () => void;
}

export default function usePhotoCapture({ onError, onDebug }: UsePhotoCaptureProps = {}): UsePhotoCaptureReturn {
  ...
  const capturePhoto = (video: HTMLVideoElement, facingMode: 'user' | 'environment', stopStream?: () => void) => {
